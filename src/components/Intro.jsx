...
export default function Intro() {
  return (
    <section id="About" className="py-6 px-4 md:py-2 md:px-1">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-4 md:mb-8">About Me</h2>
          <div
            className="p-6 rounded-2xl bg-[#DCD6f7] dark:bg-[#000018] border border-zinc-200 dark:border-zinc-800 
      ...
      transition duration-300"
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-8 ">
            ...
            {/* JOURNEY */}
            <div
              className="p-6 md:p-10 rounded-2xl bg-[#DCD6f7] dark:bg-[#000018] border border-zinc-200 dark:border-zinc-800 
      hover:shadow-lg hover:scale-[1.04] 
      transition duration-300"
            >
            ...
            {/* CURRENT FOCUS */}
            <div
              className="p-6 md:p-10 rounded-2xl bg-[#DCD6f7] dark:bg-[#000018] border border-zinc-200 dark:border-zinc-800 pb-10 
      hover:shadow-lg hover:scale-[1.04] 
      transition duration-300"
            >
